...
class ModelArguments:
    ...
    model_name_or_path: Optional[str] = field(
        default="/home/hehangshuai/workspace/tlm/tlm_dataset/gen/gen_data/Model/clm_gen_multi_v1_bucket_init",
        metadata={
            "help": (
    ...
    tokenizer_name: Optional[str] = field(
        default="/home/hehangshuai/workspace/tlm/tlm_dataset/gen/gen_data/Model/gen_tokenizer_multi_v1_bucket",
...
class DataTrainingArguments:
    ...
    train_file: Optional[str] = field(
        default="/home/hehangshuai/workspace/tlm/tlm_dataset/gen/gen_data/Train_data/align_train_multi_merged_no_ints/train_bucket_stage0.jsonl",
    ...
    sample_ratio: Optional[float] = field(
        default=0.1, metadata={"help": "Fraction of train set to sample for quick stage0 training (<=1.0)."}
    )
    ...
    def __post_init__(self):
        ...
        if self.dataset_name is None and self.train_file is None and self.validation_file is None:
            ...
            if self.train_file is not None:
                ...
                assert extension in ["csv", "json", "jsonl", "jl", "txt"], "`train_file` should be a csv/json/jsonl/txt file."
            if self.validation_file is not None:
                extension = self.validation_file.split(".")[-1]
                assert extension in ["csv", "json", "jsonl", "jl", "txt"], "`validation_file` should be a csv/json/jsonl/txt file."
...
def main():
    ...
    # Override some logging/saving defaults for stage0 quick run
    ...
    if training_args.do_train:
        if data_args.dataset_name:
            ...
            train_dataset = tokenized_datasets["train"]
            if data_args.sample_ratio is not None and data_args.sample_ratio < 1.0:
                take_n = max(1, int(len(train_dataset) * data_args.sample_ratio))
                train_dataset = train_dataset.shuffle(seed=training_args.seed).select(range(take_n))
                logger.info(f"Sampled {take_n} examples out of {len(tokenized_datasets['train'])} (ratio={data_args.sample_ratio})")
